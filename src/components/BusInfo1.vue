...
export default {
  ...
  methods: {
    ...
    created() {
      //0번째, 사상구5, 냉정역(냉정역3번출구)
      this.stopArrByBstopid(0,5291505000,195810401);

      //1번째, 사상구5-1, 냉정역5번출구
      this.stopArrByBstopid(1,5291505100,195730101);

      //2번째, 사상구5-2, 냉정역5번출구
      this.stopArrByBstopid(2,5291505200,195730101);
